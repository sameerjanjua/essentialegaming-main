                ...
                <div className="d-grid gap-2">
                    ...
                    <div className="d-flex gap-5 flex-wrap justify-content-center align-items-center">
                        ...
                        <div className="winner-card-box">
                            <h1>RUNNER UP</h1>
                            <div>
                                <MilitaryTechIcon className="winner-card-box-icon" color="success" />
                                <h2>Javed Khan</h2>
